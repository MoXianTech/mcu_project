...
typedef struct
{
	 ...
	 uint8_t sensorB_voltage[AY_NUM][AX_NUM];
} Hc4051AdcValue;

//typedef struct
//{
//	process_handle_t process_handle_A;
//	process_handle_t process_handle_B;
//}Hc4051Adcvalue;
...
void ReadAdcValue(Hc4051AdcValue *adc_raw_value,uint8_t ax_index,RESISTACE_NAME resistace_name);
