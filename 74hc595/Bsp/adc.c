...
void adc_config(void)
{
    ...
    adc_regular_channel_config(ADC0, 6, ADC_CHANNEL_6, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 7, ADC_CHANNEL_7, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 8, ADC_CHANNEL_8, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 9, ADC_CHANNEL_9, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 10, ADC_CHANNEL_10, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 11, ADC_CHANNEL_11, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 12, ADC_CHANNEL_12, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 13, ADC_CHANNEL_13, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 14, ADC_CHANNEL_14, ADC_SAMPLETIME_1POINT5);
    adc_regular_channel_config(ADC0, 15, ADC_CHANNEL_15, ADC_SAMPLETIME_1POINT5);
