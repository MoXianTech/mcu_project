...
void main(void)
{
 ...
 //数据排列转换
			...
			serial_frame.adc_value[0] = temp_adc_value.value[1][0];
			serial_frame.adc_value[1] = temp_adc_value.value[1][3];
			serial_frame.adc_value[2] = temp_adc_value.value[1][1];
			serial_frame.adc_value[3] = temp_adc_value.value[1][2];
			
			serial_frame.adc_value[4] = temp_adc_value.value[0][0];
			serial_frame.adc_value[5] = temp_adc_value.value[0][3];
			serial_frame.adc_value[6] = temp_adc_value.value[0][1];
			serial_frame.adc_value[7] = temp_adc_value.value[0][2];
			
			serial_frame.adc_value[8] = temp_adc_value.value[2][0];
			serial_frame.adc_value[9] = temp_adc_value.value[2][3];
			serial_frame.adc_value[10] = temp_adc_value.value[2][1];
			serial_frame.adc_value[11] = temp_adc_value.value[2][2];
	...
	for(x = 0; x <	3; ++x)
		{
			...
			for(y = 0; y < 4; ++y)
			{
				adc_raw_value->value[x][y] = GetAdcValue(ChooseChanneY(y+1),5)/4;
			}
		}
}
