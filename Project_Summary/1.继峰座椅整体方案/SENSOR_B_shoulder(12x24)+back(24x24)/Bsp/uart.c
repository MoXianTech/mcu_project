...
#define USART0_BUF_SIZE         			1500	
#define MAX_RING_BUF_SIZE       			1500
#define USART_RX_CACHE_BUFFER_SIZE 		1500
...
//static rcu_periph_enum COM_CLK[COMn] = {EVAL_COM0_CLK, EVAL_COM2_CLK};
//static uint32_t COM_TX_PIN[COMn] = {EVAL_COM0_TX_PIN, EVAL_COM2_TX_PIN};
//static uint32_t COM_RX_PIN[COMn] = {EVAL_COM0_RX_PIN, EVAL_COM2_RX_PIN};
//static uint32_t COM_GPIO_PORT[COMn] = {EVAL_COM0_GPIO_PORT,  EVAL_COM2_GPIO_PORT};
//static rcu_periph_enum COM_GPIO_CLK[COMn] = {EVAL_COM0_GPIO_CLK, EVAL_COM2_GPIO_CLK};
/*!
  \brief      main function
  \param[in]  none
  \param[out] none
