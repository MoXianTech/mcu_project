...
{
    /* enable CAN clock */
    rcu_periph_clock_enable(RCU_CAN0);  //CAN0 PA11-RX,PA12-TX 
...
void can0_transmit_Init(void)
{
			...
			g_transmit_message.tx_dlen = 8;  //data length
...
void communication_check(void)
{
    ...
    if(SET == can0_receive_flag){
            ...
            led_flag = !led_flag;
            RED_LED(led_flag);
//		printf("fun/lin %s-%d: %u %u %u %u %u %u %u %u\n", __FUNCTION__,
//																													__LINE__,
//																	g_receive_message.rx_data[0],
//																	g_receive_message.rx_data[1],
//																	g_receive_message.rx_data[2],
//																	g_receive_message.rx_data[3],
//																	g_receive_message.rx_data[4],
//																	g_receive_message.rx_data[5],
//																	g_receive_message.rx_data[6],
//																	g_receive_message.rx_data[7]);
