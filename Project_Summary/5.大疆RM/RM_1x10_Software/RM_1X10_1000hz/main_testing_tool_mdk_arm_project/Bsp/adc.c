...
volatile uint16_t adc_value[10]={0};
...
void adc_config(void)
{
    ...
    adc_regular_channel_config(ADC0, 8, ADC_CHANNEL_8, ADC_SAMPLETIME_7POINT5);
    adc_regular_channel_config(ADC0, 9, ADC_CHANNEL_9, ADC_SAMPLETIME_7POINT5);
