...
#define ADC_DELAY_TIME (30 * 220) //9 ns * 120
...
//			adc_raw_value.value[C][R + 4] = GetAdcValue(4) * 1000.0f;
			...
			adc_raw_value.value[C][R] = GetAdcValue(1) * 100.0f;
			adc_raw_value.value[C][R + 4] = GetAdcValue(2) * 100.0f;
			adc_raw_value.value[C][R + 8] = GetAdcValue(3) * 100.0f;
			adc_raw_value.value[C][R + 12] = GetAdcValue(4) * 100.0f;
