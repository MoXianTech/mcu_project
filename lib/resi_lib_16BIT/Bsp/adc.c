...
void gpio_config(void)
{
    /* config the GPIO as analog mode */
		gpio_mode_set(GPIOA,GPIO_MODE_ANALOG,GPIO_PUPD_NONE,GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7);
...
void adc_config(void)
{
    ...
    adc_channel_length_config(ADC0, ADC_ROUTINE_CHANNEL, 10);
    ...
    adc_routine_channel_config(ADC0, 3, ADC_CHANNEL_3, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 4, ADC_CHANNEL_4, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 5, ADC_CHANNEL_5, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 6, ADC_CHANNEL_6, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 7, ADC_CHANNEL_7, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 8, ADC_CHANNEL_8, ADC_SAMPLETIME_15);
    adc_routine_channel_config(ADC0, 9, ADC_CHANNEL_9, ADC_SAMPLETIME_15);


    /* ADC trigger config *///¹æÔòÍ¨µÀ×é£¬ Èí¼ş´¥·¢
