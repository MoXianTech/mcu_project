...
void rs2251IoInit(void)
{
    ...
    gpio_init(GPIOC, GPIO_MODE_OUT_OD, GPIO_OSPEED_50MHZ,  GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9);
}



uint8_t adc_rank_value[16] = {2,  1,  0,  3,
                              7,  4,  5,  6};
...
uint8_t single_adc_rank[8] = {5,7,6,4,2,1,0,3}; //{3, 0, 1, 2, 4, 6, 7, 5};
